...
class PruebaWidget extends StatefulWidget {
  ...
  static String routePath = '/prueba';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<InsumosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InsumosRow> pruebaInsumosRowList = snapshot.data!;

        final pruebaInsumosRow =
            pruebaInsumosRowList.isNotEmpty ? pruebaInsumosRowList.first : null;
